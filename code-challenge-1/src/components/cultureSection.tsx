  ...
  return (
    <section className="py-12" >
      ...
      <p className="text-lg text-center max-w-3xl mx-auto mt-6">
        We value teamwork, dedication, and above all, having fun. Racing isn’t just a job for us; it’s a way of life. Whether it's developing new kart technologies or planning the next big race, we approach every challenge with enthusiasm and a desire to excel.
      </p>
    </section>
    )
}
